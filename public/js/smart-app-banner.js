...
var SmartBanner = function () {
  ...
  _createClass(SmartBanner, [{
    ...
    value: function publish() {
      ...
      // edited by Rei 01052017
      var slicknav_menu = document.getElementsByClassName('slicknav_menu');
      slicknav_menu[0].style.marginTop = this.height+'px';
      // end
    ...
    value: function exit() {
      ...
      // edited by Rei 01052017
      var slicknav_menu = document.getElementsByClassName('slicknav_menu');
      slicknav_menu[0].style.marginTop = '0px';
      // end
    }
  }, {
    key: 'originalTop',
